...
export function FeedbackContentStep({ feedbackType, onFeedbackRestartedRequest ,onFeedbackSend}: FeedbackContentStepProps) {
  ...
  return (
    <>
      <header>
        ...
        <span className="flex items-center gap-2 text-sl leading-6">
